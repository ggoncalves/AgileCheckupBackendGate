...
class DateTimeUtilTest {
    ...
    void shouldThrowExceptionForNullInput() {
        // When & Then
        assertThatThrownBy(() -> DateTimeUtil.parseDateTime(null))
            .isInstanceOf(IllegalArgumentException.class)
            .hasMessage("DateTime string cannot be null");
    }
    ...
    void shouldThrowExceptionForEmptyString() {
        ...
        // When & Then
        assertThatThrownBy(() -> DateTimeUtil.parseDateTime(emptyString))
            .isInstanceOf(DateTimeParseException.class)
            .hasMessageContaining("Unable to parse datetime: " + emptyString);
    }
    ...
    void shouldThrowExceptionForInvalidDateFormat() {
        ...
        // When & Then
        assertThatThrownBy(() -> DateTimeUtil.parseDateTime(invalidDate))
            .isInstanceOf(DateTimeParseException.class)
            .hasMessageContaining("Unable to parse datetime: " + invalidDate)
            .hasMessageContaining("Expected ISO8601 format");
    }
    ...
    void shouldThrowExceptionForInvalidISO8601Format() {
        ...
        // When & Then
        assertThatThrownBy(() -> DateTimeUtil.parseDateTime(invalidISO8601))
            .isInstanceOf(DateTimeParseException.class)
            .hasMessageContaining("Unable to parse datetime: " + invalidISO8601);
    }
    ...
    void shouldThrowExceptionForMalformedTimezone() {
        ...
        // When & Then
        assertThatThrownBy(() -> DateTimeUtil.parseDateTime(malformedTimezone))
            .isInstanceOf(DateTimeParseException.class)
            .hasMessageContaining("Unable to parse datetime: " + malformedTimezone);
    }
    ...
    void shouldThrowExceptionForInvalidDateType() {
        ...
        // When & Then
        assertThatThrownBy(() -> DateTimeUtil.parseDate(invalidType))
            .isInstanceOf(IllegalArgumentException.class)
            .hasMessageContaining("Invalid date type: Integer");
    }
    ...
    void shouldThrowExceptionForInvalidStringDateFormat() {
        ...
        // When & Then
        assertThatThrownBy(() -> DateTimeUtil.parseDate(invalidDate))
            .isInstanceOf(IllegalArgumentException.class)
