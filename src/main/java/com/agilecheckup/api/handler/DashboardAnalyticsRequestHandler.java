...
public class DashboardAnalyticsRequestHandler implements RequestHandlerStrategy {
    ...
    private APIGatewayProxyResponseEvent handleComputeAnalytics(String assessmentMatrixId, Map<String, String> queryParams, Context context) {
        try {
            ...
            Map<String, Object> response = Map.of(
                ...
                "computedAt", java.time.LocalDateTime.now().toString()
            );
    ...
    private APIGatewayProxyResponseEvent handleGetPerformanceCycleSummary(String companyId, Map<String, String> queryParams) {
        try {
            ...
            PerformanceCycleSummaryResponse response = PerformanceCycleSummaryResponse.builder()
                    .companyId(companyId)
                    .companyName("Sample Company")
                    .performanceCycles(new ArrayList<>())
                    .build();
    ...
    private DashboardAnalyticsOverviewResponse buildOverviewResponse(DashboardAnalytics overview, List<DashboardAnalytics> allAnalytics) {
        try {
            ...
            DashboardAnalyticsOverviewResponse.Metadata metadata = DashboardAnalyticsOverviewResponse.Metadata.builder()
                    .assessmentMatrixId(overview.getAssessmentMatrixId())
                    .companyName(overview.getCompanyName() != null ? overview.getCompanyName() : "N/A")
                    .performanceCycle(overview.getPerformanceCycleName() != null ? overview.getPerformanceCycleName() : "N/A")
                    .assessmentMatrixName(overview.getAssessmentMatrixName() != null ? overview.getAssessmentMatrixName() : "N/A")
                    .lastUpdated(overview.getLastUpdated().toString())
                    .build();
            ...
            // Build summary
            DashboardAnalyticsOverviewResponse.Summary summary = DashboardAnalyticsOverviewResponse.Summary.builder()
                    .generalAverage(overview.getGeneralAverage())
                    .topPillar(topBottomAnalytics.getTopPillar())
                    .bottomPillar(topBottomAnalytics.getBottomPillar())
                    .topCategory(topBottomAnalytics.getTopCategory())
                    .bottomCategory(topBottomAnalytics.getBottomCategory())
                    .totalEmployees(overview.getEmployeeCount())
            ...
            return DashboardAnalyticsOverviewResponse.builder()
                    .metadata(metadata)
                    .summary(summary)
                    .teams(teams)
                    .build();
    ...
    private DashboardAnalyticsTeamResponse buildTeamResponse(DashboardAnalytics teamAnalytics) {
        try {
            ...
            return DashboardAnalyticsTeamResponse.builder()
                    .teamId(teamAnalytics.getTeamId())
                    .teamName(teamAnalytics.getTeamName())
                    .totalScore(teamAnalytics.getGeneralAverage())
                    .employeeCount(teamAnalytics.getEmployeeCount())
                    .completionPercentage(teamAnalytics.getCompletionPercentage())
    ...
    private DashboardAnalyticsOverviewResponse.TeamOverview buildTeamOverview(DashboardAnalytics analytics) {
        try {
            ...
            return DashboardAnalyticsOverviewResponse.TeamOverview.builder()
                    .teamId(analytics.getTeamId())
                    .teamName(analytics.getTeamName())
                    .totalScore(analytics.getGeneralAverage())
                    .employeeCount(analytics.getEmployeeCount())
                    .completionPercentage(analytics.getCompletionPercentage())
                    .pillarScores(pillarScores)
                    .build();
    ...
    private DashboardAnalyticsOverviewResponse.PillarScore buildPillarScore(Map<String, Object> pillarData) {
        ...
        return DashboardAnalyticsOverviewResponse.PillarScore.builder()
                .name(name != null ? name : "Unknown Pillar")
                .score(percentage != null ? percentage : 0.0)
                .actualScore(actualScore != null ? actualScore : 0.0)
                .potentialScore(potentialScore != null ? potentialScore : 0.0)
                .gapFromPotential(gapFromPotential != null ? gapFromPotential : 0.0)
    ...
    private List<DashboardAnalyticsOverviewResponse.CategoryScore> buildCategoryScores(Map<String, Object> pillarData) {
        ...
        try {
            ...
            for (Map.Entry<String, Object> categoryEntry : categories.entrySet()) {
                ...
                DashboardAnalyticsOverviewResponse.CategoryScore categoryScore = 
                    DashboardAnalyticsOverviewResponse.CategoryScore.builder()
                            .name(categoryName)
                            .score(percentage != null ? percentage : 0.0)
                            .actualScore(actualScore != null ? actualScore : 0.0)
                            .potentialScore(potentialScore != null ? potentialScore : 0.0)
                            .gapFromPotential(gapFromPotential)
                            .build();
    ...
    private DashboardAnalyticsOverviewResponse buildEmptyOverviewResponse(String assessmentMatrixId, String tenantId) {
        try {
            ...
            DashboardAnalyticsOverviewResponse.Metadata metadata = DashboardAnalyticsOverviewResponse.Metadata.builder()
                    .assessmentMatrixId(assessmentMatrixId)
                    .companyName("N/A") // Will be populated when analytics are generated
    ...
    private DashboardAnalyticsTeamResponse buildEmptyTeamResponse(String assessmentMatrixId, String teamId, String tenantId) {
        try {
            return DashboardAnalyticsTeamResponse.builder()
                    .teamId(teamId)
                    .teamName("Unknown Team") // Will be populated when analytics are generated
                    .totalScore(0.0)
                    .employeeCount(0)
                    .completionPercentage(0.0)
                    .pillarScores(new HashMap<>()) // Empty pillar scores map
            ...
            for (Map.Entry<String, Object> pillarEntry : pillars.entrySet()) {
                ...
                if (pillarPercentage != null) {
                    ...
                    if (pillarPercentage > maxPillarPercentage) {
                        ...
                        topPillar = DashboardAnalyticsOverviewResponse.PillarSummary.builder()
                                .name(pillarName)
                    ...
                    if (pillarPercentage < minPillarPercentage) {
                        ...
                        bottomPillar = DashboardAnalyticsOverviewResponse.PillarSummary.builder()
                                .name(pillarName)
                                .percentage(pillarPercentage)
                                .actualScore(actualScore != null ? actualScore : 0.0)
                                .potentialScore(potentialScore != null ? potentialScore : 0.0)
                    ...
                    for (Map.Entry<String, Object> categoryEntry : categories.entrySet()) {
                        ...
                        if (categoryPercentage != null) {
                            ...
                            if (categoryPercentage > maxCategoryPercentage) {
                                ...
                                topCategory = DashboardAnalyticsOverviewResponse.CategorySummary.builder()
                                        .name(categoryName)
                                        .pillar(pillarName)
                                        .percentage(categoryPercentage)
                                        .actualScore(categoryActualScore != null ? categoryActualScore : 0.0)
                                        .potentialScore(categoryPotentialScore != null ? categoryPotentialScore : 0.0)
                                        .build();
                            }
                            ...
                            if (categoryPercentage < minCategoryPercentage) {
                                ...
                                bottomCategory = DashboardAnalyticsOverviewResponse.CategorySummary.builder()
                                        .name(categoryName)
                                        .pillar(pillarName)
                                        .percentage(categoryPercentage)
                                        .actualScore(categoryActualScore != null ? categoryActualScore : 0.0)
    ...
    private static class TopBottomAnalytics {
        ...
        public TopBottomAnalytics(DashboardAnalyticsOverviewResponse.PillarSummary topPillar,
                                  DashboardAnalyticsOverviewResponse.PillarSummary bottomPillar,
                                  DashboardAnalyticsOverviewResponse.CategorySummary topCategory,
                                  DashboardAnalyticsOverviewResponse.CategorySummary bottomCategory) {
        ...
        public DashboardAnalyticsOverviewResponse.PillarSummary getTopPillar() { return topPillar; }
        public DashboardAnalyticsOverviewResponse.PillarSummary getBottomPillar() { return bottomPillar; }
        public DashboardAnalyticsOverviewResponse.CategorySummary getTopCategory() { return topCategory; }
        public DashboardAnalyticsOverviewResponse.CategorySummary getBottomCategory() { return bottomCategory; }
    }
    ...
    private DashboardAnalyticsTeamResponse.PillarScore buildTeamPillarScore(Map<String, Object> pillarData) {
        ...
        return DashboardAnalyticsTeamResponse.PillarScore.builder()
                .name(name != null ? name : "Unknown Pillar")
                .score(percentage != null ? percentage : 0.0)
                .actualScore(actualScore != null ? actualScore : 0.0)
                .potentialScore(potentialScore != null ? potentialScore : 0.0)
    ...
    private List<DashboardAnalyticsTeamResponse.CategoryScore> buildTeamCategoryScores(Map<String, Object> pillarData) {
        ...
        try {
            ...
            for (Map.Entry<String, Object> categoryEntry : categories.entrySet()) {
                ...
                DashboardAnalyticsTeamResponse.CategoryScore categoryScore = 
                    DashboardAnalyticsTeamResponse.CategoryScore.builder()
                            .name(categoryName)
                            .score(percentage != null ? percentage : 0.0)
                            .actualScore(actualScore != null ? actualScore : 0.0)
                            .potentialScore(potentialScore != null ? potentialScore : 0.0)
    ...
    private DashboardAnalyticsTeamResponse.WordCloud buildTeamWordCloud(Map<String, Object> analyticsData) {
        try {
            ...
            if (wordsData != null) {
                for (Map<String, Object> wordData : wordsData) {
                    ...
                    if (text != null && count != null) {
                        words.add(DashboardAnalyticsTeamResponse.WordFrequency.builder()
                                .text(text)
                                .count(count)
                                .build());
                    }
            ...
            return DashboardAnalyticsTeamResponse.WordCloud.builder()
                    .words(words)
                    .totalResponses(totalResponses != null ? totalResponses : 0)
