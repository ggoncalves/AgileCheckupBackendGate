...
public final class DateTimeUtil {
  ...
  public static LocalDateTime parseDateTime(String dateTimeString) throws DateTimeParseException {
    ...
    try {
      ...
      throw new DateTimeParseException(
          "Unable to parse datetime: " + dateTimeString + ". Expected ISO8601 format (e.g., '2025-06-19T17:54:27.862Z') or LocalDateTime format (e.g., '2025-06-19T17:54:27')", dateTimeString, e.getErrorIndex()
      );
    }
  }
  ...
  private static boolean isISO8601WithTimezone(String dateTimeString) {
    return dateTimeString.contains("T") && (dateTimeString.endsWith("Z") || (dateTimeString.contains("+") && dateTimeString.lastIndexOf("+") > dateTimeString.indexOf("T")) || (dateTimeString.contains("-") && dateTimeString.lastIndexOf("-") > dateTimeString.indexOf("T")));
  }
  ...
  public static Date parseDate(Object dateValue) {
    ...
    if (dateValue instanceof String) {
      ...
      try {
        ...
        throw new IllegalArgumentException("Invalid date format: " + dateValue + ". Expected formats: ISO8601 (e.g., '2025-06-19T17:54:27.862Z'), LocalDateTime (e.g., '2025-06-19T17:54:27'), or simple date (e.g., '2025-06-19')", e);
      }
    }
    ...
    throw new IllegalArgumentException("Invalid date type: " + dateValue.getClass().getSimpleName() + ". Expected String, Long, or null");
  }
}