            ...
            "{" +
                "\"pillars\": {" +
                    "\"pillar1\": {" +
                        ...
                        "\"percentage\": 87.5," +
                        "\"actualScore\": 175.0," +
                        "\"potentialScore\": 200.0," +
                        "\"gapFromPotential\": 12.5," +
                        "\"categories\": {" +
                            "\"cat1\": {\"name\": \"Communication\", \"percentage\": 90.0, \"actualScore\": 45.0, \"potentialScore\": 50.0}," +
                            "\"cat2\": {\"name\": \"Trust\", \"percentage\": 85.0, \"actualScore\": 85.0, \"potentialScore\": 100.0}" +
                        "}" +
                    "}," +
                    "\"pillar2\": {" +
                        ...
                        "\"actualScore\": 130.0," +
                        "\"potentialScore\": 200.0," +
                        "\"gapFromPotential\": 35.0," +
                        "\"categories\": {" +
                            "\"cat3\": {\"name\": \"Code Quality\", \"percentage\": 70.0, \"actualScore\": 70.0, \"potentialScore\": 100.0}," +
                            "\"cat4\": {\"name\": \"Testing\", \"percentage\": 60.0, \"actualScore\": 60.0, \"potentialScore\": 100.0}" +
                        "}" +
                    "}" +
                "}" +
            "}";
            ...
            "{" +
                "\"pillars\": {" +
                    "\"pillar1\": {" +
                        ...
                        "\"actualScore\": 150.0," +
                        "\"potentialScore\": 200.0," +
                        "\"gapFromPotential\": 25.0," +
                        "\"categories\": {" +
                            "\"cat1\": {\"name\": \"Only Category\", \"percentage\": 75.0, \"actualScore\": 75.0, \"potentialScore\": 100.0}" +
                        "}" +
                    "}" +
                "}" +
            "}";
            ...
            "{" +
                "\"pillars\": {" +
                    "\"pillar1\": {" +
                        ...
                        "\"actualScore\": 160.0," +
                        "\"potentialScore\": 200.0," +
                        "\"gapFromPotential\": 20.0," +
                        "\"categories\": {" +
                            "\"cat1\": {\"name\": \"Communication\", \"percentage\": 85.0}," + // Missing actualScore, potentialScore
