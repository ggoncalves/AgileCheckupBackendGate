...
class AnswerRequestHandlerTest {
  ...
  void shouldSuccessfullyGetAllAnswers() {
    // Given
    APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent().withPath("/answers").withHttpMethod("GET");
  ...
  void shouldSuccessfullyGetAnswerById() {
    ...
    APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent().withPath("/answers/" + answerId).withHttpMethod("GET");
  ...
  void shouldSuccessfullyGetAnswersByEmployeeAssessmentId() {
    ...
    APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent().withPath("/answers/employeeassessment/" + employeeAssessmentId).withHttpMethod("GET").withQueryStringParameters(queryParams);
  ...
  void shouldReturnBadRequestWhenTenantIdMissingForEmployeeAssessment() {
    // Given
    String employeeAssessmentId = "ea-123";
    APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent().withPath("/answers/employeeassessment/" + employeeAssessmentId).withHttpMethod("GET");
  ...
  void shouldSuccessfullyCreateAnswer() {
    ...
    APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent().withPath("/answers").withHttpMethod("POST").withBody(requestBody);
    ...
    when(answerService.create(
        eq("ea-123"), eq("q-123"), any(LocalDateTime.class), eq("Yes"), eq("tenant-123"), isNull()
  ...
  void shouldSuccessfullyUpdateAnswer() {
    ...
    APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent().withPath("/answers/" + answerId).withHttpMethod("PUT").withBody(requestBody);
    ...
    when(answerService.update(
        eq(answerId), any(LocalDateTime.class), eq("No"), eq("Updated answer")
  ...
  void shouldSuccessfullyDeleteAnswer() {
    ...
    APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent().withPath("/answers/" + answerId).withHttpMethod("DELETE");
  ...
  void shouldReturnBadRequestWhenCreateFails() {
    ...
    doReturn(Optional.empty()).when(answerService).create(
        anyString(), anyString(), any(LocalDateTime.class), anyString(), anyString(), nullable(String.class));
  ...
  void shouldReturnMethodNotAllowedForUnsupportedMethod() {
    // Given
    APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent().withPath("/answers").withHttpMethod("PATCH");
  ...
  void shouldSuccessfullySaveAnswerAndGetNext() throws Exception {
    ...
    AnswerWithProgressResponse mockResponse = AnswerWithProgressResponse.builder().question(null) // Null indicates assessment completed
        .existingAnswer(null).currentProgress(5).totalQuestions(5).build();
    ...
    APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent().withPath("/answers/save-and-next").withHttpMethod("POST").withBody(objectMapper.writeValueAsString(requestBody));
  ...
  void shouldReturnMethodNotAllowedForSaveAndNextWithGetMethod() {
    // Given
    APIGatewayProxyRequestEvent request = new APIGatewayProxyRequestEvent().withPath("/answers/save-and-next").withHttpMethod("GET");
  ...
  void shouldHandleISO8601DateTimeWithMillisecondsAndTimezone() throws Exception {
    ...
    AnswerWithProgressResponse mockResponse = AnswerWithProgressResponse.builder().question(null).existingAnswer(null).currentProgress(1).totalQuestions(1).build();

    when(assessmentNavigationService.saveAnswerAndGetNext(
        eq(employeeAssessmentId), eq(questionId), any(LocalDateTime.class), eq(value), eq(tenantId), eq(notes)
    )).thenReturn(mockResponse);
